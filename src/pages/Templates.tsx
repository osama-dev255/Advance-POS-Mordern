                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex flex-wrap gap-2 mt-4">
                              ...
                              <Button 
                                size="sm" 
                                variant="outline" 
                                onClick={() => template.type === "delivery-note" ? handlePreviewTemplate(template.id) : handlePrintPreview(template.id)}
                              >
                              ...
                              <Button 
                                size="sm" 
                                variant="outline" 
                                onClick={() => template.type === "delivery-note" ? handlePreviewTemplate(template.id) : handleExportTemplate(template.id)}
                              >
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button onClick={handleDownloadDeliveryNote}>
                      <Download className="h-4 w-4 mr-2" />
                      Download
                    </Button>
                  </div>
